...
export default function Personal() {
  ...
  return (
    <main>
      <section className="hero-container" style={{ backgroundImage: `url(${post.image})` }}>
        ...
        <div className="relo rounded-pill">
          ...
          <i className="fa-solid fa-angle-left"></i>
          <NavLink className="active" to={`/blog/${categoryData.path}`}>
            {post.category}
          </NavLink>
        </div>
        <div className="relo1">
          <div className="d-flex align-items-center gap-4">
            <div
              className="rounded-pill px-3 py-2 z-3"
              style={{ backgroundColor: 'rgb(238 96 15)' }}
            >
              <NavLink to={`/blog/${categoryData.path}`}>{post.category}</NavLink>
            </div>
            <div className="article-meta d-flex gap-3 text-white">
              <span className="date-info order-1">
                <i className="far fa-calendar ms-1"></i> {post.date}
              </span>
              <span className="time-info order-2">
          ...
          <div className="bg rounded-4 d-inline-flex gap-3 align-items-center my-3">
            <div className="imav rounded-circle">
              <img className="w-100 rounded-circle " src={post.author.avatar} alt="" />
            </div>
            <div>
      ...
      <div className="bg-black">
        <div className="container py-4">
          <div className="row py-5 g-3" style={{ borderBottom: '1px solid rgb(38 38 38)' }}>
            <div className="col-lg-8 high">
              <p className="highlight mb-4">"{post.excerpt}"</p>

              <p className="py-3">{post.content.split('\n\n')[0]}</p>
              ...
              <div className="py-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <h3 className="my-3">
                    المعدات الأساسية <i className="bi bi-camera"></i>
                  </h3>
                </div>
              ...
              <div className="py-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <h3 className="my-3">
                    توقيت التصوير <i className="bi bi-camera"></i>
                  </h3>
                </div>
                <p>{post.content.split('\n\n')[4]}</p>
              </div>
              ...
              <div className="py-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <h3 className="my-3">
                    التكوين الفني <i className="bi bi-camera"></i>
                  </h3>
                </div>
                <p>{post.content.split('\n\n')[6]}</p>
              </div>
              ...
              <div className="py-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <h3 className="my-3">
                    إعدادات الكاميرا <i className="bi bi-camera"></i>
                  </h3>
                </div>
                <p>{post.content.split('\n\n')[8]}</p>
              </div>
              ...
              <div className="py-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <h3 className="my-3">
                    المعالجة اللاحقة <i className="bi bi-camera"></i>
                  </h3>
                </div>
                <p>{post.content.split('\n\n')[10]}</p>
              </div>
              ...
              <div className="py-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <h3 className="my-3">
                    الخلاصة <i className="bi bi-camera"></i>
                  </h3>
                </div>
                <p>{post.content.split('\n\n')[12]}</p>
              </div>
              ...
              <div
                className="p-3 mt-3 rounded-4 d-flex justify-content-between align-items-center"
              ...
              >
                ...
                <div className="d-flex gap-2">
                  <div className="lis1 li1 rounded-3 d-flex justify-content-center align-items-center">
                    <i className="fa-brands fa-twitter"></i>
                  </div>
                  <div className="lis1 li1 rounded-3 d-flex justify-content-center align-items-center">
                    <i className="fa-brands fa-linkedin-in"></i>
                  </div>
                  <div className="lis1 li2 rounded-3 d-flex justify-content-center align-items-center">
                    <i className="fa-brands fa-whatsapp"></i>
                  </div>
                  <div className="lis1 li3 rounded-3 d-flex justify-content-center align-items-center">
              ...
              <div className="p-3 mt-3 rounded-4" style={{ backgroundColor: '#111' }}>
                <div className="d-flex align-items-center gap-4 py-3">
                  <div className="lisim rounded-3 d-flex justify-content-center align-items-center">
                    <img
              ...
              <div className="sticky-sidebar-container">
                <div className="sidebar py-4 rounded-4">
                  ...
                  <ul className="p-0 mt-3">
                    <li>
                      <span className="badge">1</span>المعدات الأساسية
                    </li>
                    <li>
                      <span className="badge">2</span>توقيت التصوير
                    </li>
                    <li>
                      <span className="badge">3</span>التكوين الفني
                    </li>
                    <li>
                      <span className="badge">4</span>إعدادات الكاميرا
                    </li>
                    <li>
                      <span className="badge">5</span>المعالجة اللاحقة
                    </li>
                    <li>
                      <span className="badge">6</span>الخلاصة
                    </li>
                  </ul>
                </div>
                ...
                <div className="sidebar3 grid grid-cols-2 gap-3 text-center rounded-4">
                  <div className="d-flex justify-content-center align-items-center pb-2">
                    <div className="lismass rounded-4 d-flex justify-content-center align-items-center">
                      <i className="fa-solid fa-envelope fa-xl text-orange"></i>
                    </div>
                  </div>
                  <div>
                    ...
                    >
                      اشترك للحصول علي احدث المقالات
                    </p>
                    <NavLink to="/blog" className="btnor">
                      تصفح المزيد
                    </NavLink>
                  </div>
                </div>
          ...
          <div className="d-flex justify-content-between my-5">
            <div className="d-flex gap-3 align-items-end">
              <div className="liscam rounded-4 d-flex justify-content-center align-items-center">
                <i className="fa-solid fa-images text-orange fa-xl"></i>
              </div>
              <div>
