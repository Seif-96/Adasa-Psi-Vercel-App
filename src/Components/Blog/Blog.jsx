        ...
        <div className='container d-flex justify-content-between align-items-center'>
          <div className='NavLeft'>
            <div className="position-relative">
              ...
              />
              <i className="fa-solid fa-magnifying-glass ic" style={{ color: "rgb(117 117 117)" }}></i>
            </div>
          </div>
          ...
          <div className='NavRight'>
            <ul className='d-flex gap-2 typ ps-0'>
              ...
              <li>
                <NavLink to="lighting" onClick={() => setActiveCategory("lighting")}>إضاءة</NavLink>
              </li>
              <li>
                <NavLink to="portrait" onClick={() => setActiveCategory("portrait")}>بورتريه</NavLink>
              </li>
              <li>
                <NavLink to="landScape" onClick={() => setActiveCategory("landScape")}>مناظر طبيعية</NavLink>
              </li>
              <li>
                <NavLink to="techniq" onClick={() => setActiveCategory("techniq")}>تقنيات</NavLink>
              </li>
              <li>
                <NavLink to="Equipment" onClick={() => setActiveCategory("Equipment")}>معدات</NavLink>
              </li>
            </ul>
          </div>
        </div>
