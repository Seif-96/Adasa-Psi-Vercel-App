  ...
  return (
    <>
      <section className="hero-section text-center">
        <div className="container hero-content-wrapper">
          ...
          <div className="d-flex justify-content-center gap-3 flex-wrap mb-5">
            <NavLink to="blog" className="hero-btn-main col-12  col-md-auto rounded-pill gap-3">
              استكشف المقالات <i className="p-1 fa-solid fa-arrow-left-long"></i>
            </NavLink>
            <NavLink
              to="info"
              className="gap-2 rounded-pill col-12 col-md-auto hero-btn-outline d-flex justify-content-center align-items-center"
            >
      ...
      <section className="bage-two">
        <div className="container">
          ...
          {posts.slice(0, 3).map((post) => (
            <NavLink key={post.id} to={`/personal/${post.slug}`} className="text-decoration-none">
                ...
                <div className="row g-0 h-100">
                  ...
                  <div className="col-md-6 headLeft d-flex flex-column justify-content-center p-4 order-md-2">
                    <div className="d-flex gap-3 align-items-center mb-3 w-100">
                      <span className="category-tag rounded-pill">{post.category}</span>
                    ...
                    <div className="mt-auto d-flex justify-content-between mb-3">
                      <div className="d-flex gap-3">
                        ...
                        <div>
                          <span className="d-block text-white mb-1">{post.author.name}</span>
                          <span style={{ color: 'rgb(93 89 88)' }}>{post.date}</span>
                        </div>
                      </div>
      ...
      <div className="main-container py-5 px-3">
        <div className="container">
          <div
            className="d-flex justify-content-between align-items-end mb-5 text-end flex-wrap-reverse"
            dir="rtl"
          >
            ...
            <NavLink to="/blog" className="view-all-link mb-3">
        ...
        <div className="container">
          <div className="newsletter-card mx-auto p-5 text-center">
            ...
            <h2 className="newsletter-title mb-3 ">
              اشترك في <span className="co">نشرتنا الإخبارية</span>
            </h2>
            ...
            <div
              className="newsletter-footer d-flex align-items-center justify-content-center flex-wrap gap-3 mt-4"
              dir="rtl"
            >
